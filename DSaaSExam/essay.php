...
<head>
	...
	<title>View Essays (DSAdmin) - DSaaS Exam</title>
...
<table class="table text-center table-bordered">
  ...
  <tr>
    ...
    <tr>
      <td colspan = "2">
<button class="btn btn-success d-block m-auto" style = "width:100%;" type="submit"> Submit Scores </button>
</form>
</td>
</tr>
      <?php
...
<table class="table text-center table-bordered">
  ...
  <tr>
    ...
    <tr>
      <td colspan = "2">
<a href="searchessay.php" class="btn btn-primary d-block m-auto text-white" > Back </a>
</td>
</tr>
</table>
 <footer>
