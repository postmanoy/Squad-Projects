...
{ 
   ...
   <body>
      ...
      <div>
         <h1 class="text-center text-white w3-black" style = "font-family: 'Lato', sans-serif;">  PH DSaaS Enablement Exam </h1><br>
               ...
               <form action="checked.php" name = "form" id = "form" method="post">
                 ...
                 <div class = "card border border-dark">
                  ...
                  <div class ="card-body bg-dark text-white">
                        ...
                        <input type = "hidden" name="quizcheckcat[<?php echo $rowsq['q_id'] ;?>]" value="<?php echo $rowsq['cat_id'] ; ?>"><?php //kunin ung value ng category ?>
                        <input type = "hidden" name="quizcheckid[<?php echo $rowsq['q_id'] ;?>]" value="<?php echo $rowsq['q_id'] ; ?>"><?php //kunin ung value ng category ?>
                     </div>
                  <?php
               }
