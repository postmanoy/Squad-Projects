        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                  <div class="navbar-nav ml-auto">
                    ...
                    &nbsp;
                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#ViewAccessLog">View Access Log</button>
                  </div>
                </div>
        </nav>
                ...
                <div class="col">
                    <form>
                            <div class="form-group">
                                    ...
                                    <input class="form-control" id ="dsc" list="dscl" value = "N/A" autocomplete="off">
                                    <datalist id="dscl">
                            ...
                            <div class="form-group">
                                    <label for="exampleFormControlSelect1"><b>Problematic Module:</b></label>
                                   <input class="form-control" id ="prbm" list="prbml" value = "N/A" autocomplete="off">
                                    <datalist id="prbml">
                                      <option value="N/A">N/A</option>
                                      <?php
                                            $qprbm = "select * from prbm";
                ...
                <div class="col">
                        <form>
                                <div class="form-group">
                                        ...
                                        <input class="form-control" id ="ic" list="icl" value = "N/A" autocomplete="off">
                                        <datalist id="icl">
                                          <option value="N/A">N/A</option>
                                          <?php
                                              $qic = "select * from ic";
                                ...
                                <div class="form-group">
                                        ...
                                        <input class="form-control" id ="sc" list="scl" value = "N/A" autocomplete="off">
                                        <datalist id="scl">
                                          <option value="N/A">N/A</option>
                                        </datalist>
                                </div>
